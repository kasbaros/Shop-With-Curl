...
// Main deployment process
    try {
        ...
        // Check and seed admin users if needed
        update_status('seeding', 'Checking and seeding admin users');
        if (!check_admin_users_exist()) {
            ...
            log_message("Admin users already exist, skipping seeding");
        }
