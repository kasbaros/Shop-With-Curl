            ...
            <div class="container-full">
                <div class="masonry-layout-v4 style-2 wow fadeInUp" data-wow-delay="0s">
                    <div class="item-1 collection-item style-2 hover-img">
                        <div class="collection-inner">
                            <a href="shop-collection-sub.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/cls-activewear1.jpg"
                                    src="images/collections/cls-activewear1.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-collection-sub.html"
                                    class="tf-btn collection-title hover-icon font-young-serif text-22 rounded-full"><span>T-shirt
                                        & Top</span><i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item-2 collection-item style-2 hover-img">
                        <div class="collection-inner">
                            <a href="shop-collection-sub.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/cls-activewear2.jpg"
                                    src="images/collections/cls-activewear2.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-collection-sub.html"
                    ...
                    <div class="item-3 collection-item style-2 hover-img">
                        <div class="collection-inner">
                            <a href="shop-collection-sub.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/cls-activewear3.jpg"
                                    src="images/collections/cls-activewear3.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-collection-sub.html"
            ...
            <div class="container">
                <div class="flat-title mb_1 flex-row justify-content-between px-0">
                    ...
                    <div class="box-sw-navigation">
                        <div class="nav-sw round nav-next-brand nav-next-slider"><span
                                class="icon icon-arrow1-left"></span></div>
                        <div class="nav-sw round nav-prev-brand nav-prev-slider"><span
                                class="icon icon-arrow1-right"></span></div>
                    </div>
                </div>
                <div class="hover-sw-nav hover-sw-3">
                    <div dir="ltr" class="swiper tf-sw-brand rounded-0 border-0 wrap-sw-over" data-loop="false"
                        data-play="false" data-preview="4" data-tablet="3" data-mobile="2" data-space-lg="30"
                        data-space-md="15">
                        <div class="swiper-wrapper">
                                ...
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/brown-11.jpg"
                                                src="images/products/brown-11.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/brown-12.jpg"
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/blue-5.jpg"
                                                src="images/products/blue-5.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/blue-6.jpg"
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                ...
                                                <img class="lazyload" data-src="images/products/blue-5.jpg"
                                                    src="images/products/blue-5.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/black-25.jpg"
                                                    src="images/products/black-25.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Red</span>
                                                <span class="swatch-value bg_red"></span>
                                                <img class="lazyload" data-src="images/products/red.jpg"
                                                    src="images/products/red.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Brown</span>
                                                <span class="swatch-value bg_brown"></span>
                                                <img class="lazyload" data-src="images/products/brown-13.jpg"
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/white-17.jpg"
                                                src="images/products/white-17.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/white-18.jpg"
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                ...
                                                <img class="lazyload" data-src="images/products/white-17.jpg"
                                                    src="images/products/white-17.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Green</span>
                                                <span class="swatch-value bg_green"></span>
                                                <img class="lazyload" data-src="images/products/green-2.jpg"
                                                    src="images/products/green-2.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/black-26.jpg"
                                                    src="images/products/black-26.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Pink</span>
                                                <span class="swatch-value bg_pink"></span>
                                                <img class="lazyload" data-src="images/products/pink-5.jpg"
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/grey-3.jpg"
                                                src="images/products/grey-3.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/grey-4.jpg"
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                ...
                                                <img class="lazyload" data-src="images/products/grey-3.jpg"
                                                    src="images/products/grey-3.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Green</span>
                                                <span class="swatch-value bg_green"></span>
                                                <img class="lazyload" data-src="images/products/green-3.jpg"
                                                    src="images/products/green-3.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/black-27.jpg"
                                            ...
                                            <li class="list-color-item color-swatch">
                                                ...
                                                <img class="lazyload" data-src="images/products/light-green-6.jpg"
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/white-19.jpg"
                                                src="images/products/white-19.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/white-20.jpg"
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">White</span>
                                                <span class="swatch-value bg_white"></span>
                                                <img class="lazyload" data-src="images/products/white-19.jpg"
                                                    src="images/products/white-19.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/black-28.jpg"
                                                    src="images/products/black-28.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Brown</span>
                                                <span class="swatch-value bg_brown"></span>
                                                <img class="lazyload" data-src="images/products/brown-14.jpg"
                                                    src="images/products/brown-14.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Green</span>
                                                <span class="swatch-value bg_green"></span>
                                                <img class="lazyload" data-src="images/products/green-4.jpg"
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/black-29.jpg"
                                                src="images/products/black-29.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/black-30.jpg"
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/black-29.jpg"
                                                    src="images/products/black-29.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Green</span>
                                                <span class="swatch-value bg_green"></span>
                                                <img class="lazyload" data-src="images/products/green-5.jpg"
                                                    src="images/products/green-5.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Blue</span>
                                                <span class="swatch-value bg_blue-2"></span>
                                                <img class="lazyload" data-src="images/products/blue-7.jpg"
                                            ...
                                            <li class="list-color-item color-swatch">
                                                ...
                                                <img class="lazyload" data-src="images/products/light-blue-4.jpg"
                    ...
                    <div class="nav-sw nav-next-slider nav-next-brand box-icon w_46 round"><span
                            class="icon icon-arrow-left"></span></div>
                    <div class="nav-sw nav-prev-slider nav-prev-brand box-icon w_46 round"><span
        ...
        <section>
            <div class="container">
                <div class="tf-hero-image-liquid radius-10 o-hidden banner-countdown-v2">
                    <img class="lazyload" data-src="images/slider/banner-countdown-2.png"
                        src="images/slider/banner-countdown-2.png" alt="img-banner" loading="lazy">
                    <div class="box-content">
                        ...
                        <a href="shop-default.html" class="tf-btn btn-fill btn-md animate-hover-btn radius-60">Shop now
                            - $129</a>
                    </div>
                </div>
            </div>
                ...
                <div class="flat-animate-tab">
                    ...
                    <div class="tab-content">
                                            ...
                                            <div class="card-product-wrapper">
                                                <a href="product-detail.html" class="product-img">
                                                    ...
                                                    <img class="lazyload img-hover"
                                                        ...
                                                        src="images/products/sports-clothing-2.jpg" alt="image-product">
                                                </a>
                                                <div class="list-product-btn">
                                                    <a href="#quick_add" data-bs-toggle="modal"
                                                        class="box-icon bg_white quick-add tf-btn-loading">
                                            ...
                                            <div class="card-product-info">
                                                ...
                                                <ul class="list-color-product">
                                                    <li class="list-color-item color-swatch active">
                                                        <span class="tooltip">Brown</span>
                                                        <span class="swatch-value bg_brown"></span>
                                                        <img class="lazyload" data-src="images/products/brown-15.jpg"
                                                            src="images/products/brown-15.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Green</span>
                                                        <span class="swatch-value bg_green"></span>
                                                        <img class="lazyload" data-src="images/products/green-6.jpg"
                                            ...
                                            <div class="card-product-wrapper">
                                                <a href="product-detail.html" class="product-img">
                                                    <img class="lazyload img-product"
                                                        ...
                                                        src="images/products/sports-clothing-3.jpg" alt="image-product">
                                                    <img class="lazyload img-hover"
                                                        data-src="images/products/sports-clothing-4.jpg"
                                                        src="images/products/sports-clothing-4.jpg" alt="image-product">
                                                </a>
                                                <div class="list-product-btn">
                                                    <a href="#quick_add" data-bs-toggle="modal"
                                                        class="box-icon bg_white quick-add tf-btn-loading">
                                            ...
                                            <div class="card-product-info">
                                                ...
                                                <ul class="list-color-product">
                                                    ...
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Black</span>
                                                        <span class="swatch-value bg_dark"></span>
                                                        <img class="lazyload" data-src="images/products/black-31.jpg"
                                                            src="images/products/black-31.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Blue</span>
                                                        <span class="swatch-value bg_blue-2"></span>
                                                        <img class="lazyload" data-src="images/products/blue-8.jpg"
                                                            src="images/products/blue-8.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Brown</span>
                                                        <span class="swatch-value bg_brown"></span>
                                                        <img class="lazyload" data-src="images/products/brown-16.jpg"
                                            ...
                                            <div class="card-product-wrapper">
                                                <a href="product-detail.html" class="product-img">
                                                    <img class="lazyload img-product"
                                                        ...
                                                        src="images/products/sports-clothing-6.jpg" alt="image-product">
                                                    <img class="lazyload img-hover"
                                                        data-src="images/products/sports-clothing-5.jpg"
                                                        src="images/products/sports-clothing-5.jpg" alt="image-product">
                                                </a>
                                                <div class="list-product-btn">
                                                    <a href="#quick_add" data-bs-toggle="modal"
                                                        class="box-icon bg_white quick-add tf-btn-loading">
                                            ...
                                            <div class="card-product-info">
                                                ...
                                                <ul class="list-color-product">
                                                    ...
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Grey</span>
                                                        <span class="swatch-value bg_grey"></span>
                                                        <img class="lazyload" data-src="images/products/grey-5.jpg"
                                                            src="images/products/grey-5.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Brown</span>
                                                        <span class="swatch-value bg_brown"></span>
                                                        <img class="lazyload" data-src="images/products/brown-17.jpg"
                                            ...
                                            <div class="card-product-wrapper">
                                                <a href="product-detail.html" class="product-img">
                                                    <img class="lazyload img-product"
                                                        ...
                                                        src="images/products/sports-clothing-7.jpg" alt="image-product">
                                                    <img class="lazyload img-hover"
                                                        data-src="images/products/sports-clothing-8.jpg"
                                                        src="images/products/sports-clothing-8.jpg" alt="image-product">
                                                </a>
                                                <div class="list-product-btn">
                                                    <a href="#quick_add" data-bs-toggle="modal"
                                                        class="box-icon bg_white quick-add tf-btn-loading">
                                            ...
                                            <div class="card-product-info">
                                                ...
                                                <ul class="list-color-product">
                                                    ...
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">White</span>
                                                        <span class="swatch-value bg_white"></span>
                                                        <img class="lazyload" data-src="images/products/white-21.jpg"
                                                            src="images/products/white-21.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Brown</span>
                                                        <span class="swatch-value bg_brown"></span>
                                                        <img class="lazyload" data-src="images/products/brown-18.jpg"
                                                            src="images/products/brown-18.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Black</span>
                                                        <span class="swatch-value bg_dark"></span>
                                                        <img class="lazyload" data-src="images/products/black-32.jpg"
                                            ...
                                            <div class="card-product-info">
                                                ...
                                                <ul class="list-color-product">
                                                    <li class="list-color-item color-swatch active">
                                                        <span class="tooltip">Light Blue</span>
                                                        <span class="swatch-value bg_light-blue"></span>
                                                        <img class="lazyload" data-src="images/products/t-shirt-15.jpg"
                                                            src="images/products/t-shirt-15.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">White</span>
                                                        <span class="swatch-value bg_white"></span>
                                                        <img class="lazyload" data-src="images/products/white-22.jpg"
                                                            src="images/products/white-22.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Green</span>
                                                        <span class="swatch-value bg_green"></span>
                                                        <img class="lazyload" data-src="images/products/green-7.jpg"
                                                            src="images/products/green-7.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Brown</span>
                                                        <span class="swatch-value bg_brown"></span>
                                                        <img class="lazyload" data-src="images/products/brown-19.jpg"
                        ...
                        <div class="tab-pane hover-sw-nav" id="women" role="tabpanel">
                            <div class="tf-sw-product-sell-1 wrap-sw-over" data-preview="4" data-tablet="3"
                                data-mobile="2" data-space-lg="30" data-space-md="15" data-pagination="2"
                                data-pagination-md="2" data-pagination-lg="1">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                        ...
                        <div class="flat-lookbook-v3 d-flex">
                            <div class="col-left w-50">
                                <div class="slider-wrap-lookbook">
                                    <div class="inner-sw-lookbook">
                                        ...
                                        <form>
                                            <div dir="ltr" class="swiper tf-lookbook " data-preview="3" data-tablet="1"
                                                data-mobile="1" data-space-lg="0" data-space-md="0">
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide" lazy="true">
                                            ...
                                            <button type="submit"
                                                class="tf-btn justify-content-center style-2 btn-fill radius-3 animate-hover-btn">Add
                                                selected to cart - $114.00 USD</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            <div class="col-right w-50">
                                <div class="wrap-lookbook lookbook-sw">
                                    <div class="image">
                                        <img class="lazyload" data-src="images/shop/file/lb-activewear.jpg"
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2 tf-img-with-text style-5">
                    <div class="tf-image-wrap wow fadeInUp" data-wow-delay="0s">
                        <img class="lazyload" data-src="images/collections/banner-collection-activewear.jpg"
                            src="images/collections/banner-collection-activewear.jpg" alt="collection-img">
                    </div>
                    <div class="tf-content-wrap wow fadeInUp" data-wow-delay="0s">
                        ...
                        <p class="description text_black-2 fs-14">Since our inception in late 2012, ECfriend has had one
                            intention;
        ...
        <section class="bg_grey-7 flat-spacing-18">
            <div class="container">
                <div class="wrap-carousel">
                    <div dir="ltr" class="swiper tf-sw-testimonial" data-preview="2" data-tablet="2" data-mobile="1"
                        data-space-lg="30" data-space-md="15">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-item style-row">
                                    <div class="image radius-5 o-hidden">
                                        <img class="lazyload" data-src="images/item/tes-wear1.jpg" alt=""
                                            src="images/item/tes-wear1.jpg">
                                    </div>
                                    <div class="content">
                                        <div class="rating">
                                            <i class="icon-star"></i>
                                        ...
                                        <div class="product">
                                            <div class="img-thumb radius-5 o-hidden">
                                                <img class="lazyload" data-src="images/products/brown-11.jpg" alt=""
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item style-row">
                                    <div class="image radius-5 o-hidden">
                                        <img class="lazyload" data-src="images/item/tes-wear2.jpg" alt=""
                                            src="images/item/tes-wear2.jpg">
                                    </div>
                                    <div class="content">
                                        <div class="rating">
                                            <i class="icon-star"></i>
                                        ...
                                        <div class="product">
                                            <div class="img-thumb radius-5 o-hidden">
                                                <img class="lazyload" data-src="images/products/white-17.jpg" alt=""
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item style-row">
                                    <div class="image radius-5 o-hidden">
                                        <img class="lazyload" data-src="images/item/tes-wear3.jpg" alt=""
                                            src="images/item/tes-wear3.jpg">
                                    </div>
                                    <div class="content">
                                        <div class="rating">
                                            <i class="icon-star"></i>
                                        ...
                                        <div class="product">
                                            <div class="img-thumb radius-5 o-hidden">
                                                <img class="lazyload" data-src="images/products/blue-5.jpg" alt=""
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item style-row">
                                    <div class="image radius-5 o-hidden">
                                        <img class="lazyload" data-src="images/item/tes-wear4.jpg" alt=""
                                            src="images/item/tes-wear4.jpg">
                                    </div>
                                    <div class="content">
                                        <div class="rating">
                                            <i class="icon-star"></i>
                                        ...
                                        <div class="product">
                                            <div class="img-thumb radius-5 o-hidden">
                                                <img class="lazyload" data-src="images/products/sports-clothing-6.jpg"
                                                    alt="" src="images/products/sports-clothing-6.jpg">
                                            </div>
                                            <div class="content-wrap">
                                                <div class="product-title">
                    ...
                    <div class="nav-sw disable-line nav-next-slider nav-next-testimonial lg"><span
                            class="icon icon-arrow-left"></span></div>
                    <div class="nav-sw disable-line nav-prev-slider nav-prev-testimonial lg"><span
                            class="icon icon-arrow-right"></span></div>
        ...
        <section class="flat-spacing-10">
            <div class="container">
                <div class="flat-title mb_1 wow fadeInUp" data-wow-delay="0s">
                    ...
                    <p class="sub-title text_black-2">Follow <strong>@ecactive</strong> on Instagram</p>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover"
                                            data-src="images/shop/gallery/activewear-gallery6.jpg"
                                            src="images/shop/gallery/activewear-gallery6.jpg" alt="image-gallery">
                                    </div>
                                    <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span>
                                        <span class="tooltip">View product</span></a>
                                </div>
