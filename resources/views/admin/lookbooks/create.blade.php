...
@section('title', 'Add Lookbook')
@section('page-title', 'Add Lookbook')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 mb-0">Add New Lookbook</h2>
            <p class="text-muted mb-0">Create a product collection or bundle offer</p>
        </div>
            ...
            <div class="col-lg-8">
                <div class="stat-card p-4 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text">This image will be displayed on the right side of the lookbook section</div>
                        @error('image')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary btn-admin">
                        <i class="bi bi-check-circle me-1"></i> Create Lookbook
                    </button>
                    <a href="{{ route('admin.lookbooks.index') }}" class="btn btn-outline-secondary">
