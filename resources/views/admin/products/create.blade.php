        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="stat-card p-4 mb-4">
                    ...
                    <!-- Featured Image -->
                    <div class="mb-4">
                        <h6 class="fw-semibold">Featured Image</h6>
                        <div class="mb-3">
                            <label for="featured_image" class="form-label">Upload Featured Image</label>
                            <input type="file" class="form-control @error('featured_image') is-invalid @enderror"
                                   id="featured_image" name="featured_image" accept="image/*">
                            <div class="form-text">Recommended: 800x800px. Max 4MB. This will be the main product image.</div>
                        ...
                        <div id="featuredImagePreview" class="row g-3 mb-3" style="display: none;">
                            <div class="col-md-4">
                                <div class="position-relative">
                                    ...
                                    <div class="badge bg-success position-absolute top-0 start-0 m-2">Featured</div>
                                </div>
                    ...
                    <!-- Gallery Images -->
                    <div class="mb-4">
                        <h6 class="fw-semibold">Gallery Images</h6>
                        <div class="mb-3">
                            <label for="images" class="form-label">Upload Gallery Images</label>
                            <input type="file" class="form-control @error('images.*') is-invalid @enderror"
                                   id="images" name="images[]" multiple accept="image/*">
                            <div class="form-text">
                                Upload multiple images (JPEG, PNG, JPG, GIF, WebP). Max 4MB per image.
                            </div>
                            @error('images.*')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
