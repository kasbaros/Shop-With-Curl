...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 mb-0">Edit Gallery Item</h2>
            <p class="text-muted mb-0">Update an existing gallery item</p>
        </div>
    ...
    <form action="{{ route('admin.gallery.update', $galleryItem) }}" method="POST" enctype="multipart/form-data" id="galleryForm">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                <div class="stat-card p-4 mb-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="source_type"
                                           id="sourceUpload" value="upload"
                                        {{ old('source_type', $galleryItem->source_type) === 'upload' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="source_type"
                                        ...
                                        {{ old('source_type', $galleryItem->source_type) === 'instagram' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="source_type"
                                        ...
                                        {{ old('source_type', $galleryItem->source_type) === 'customer' ? 'checked' : '' }}>
                    ...
                    <div class="mb-4" id="imageUploadDiv">
                        <label for="image" class="form-label fw-medium">Replace with New Image</label>
                    ...
                    <!-- Image URL -->
                    <div class="mb-4" id="imageUrlDiv">
                        <label for="image_url" class="form-label fw-medium">Image URL</label>
                        <input type="url" class="form-control @error('image_url') is-invalid @enderror"
                               id="image_url" name="image_url"
                               value="{{ old('image_url', filter_var($galleryItem->image, FILTER_VALIDATE_URL) ? $galleryItem->image : '') }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('caption') is-invalid @enderror"
                               ...
                               value="{{ old('caption', $galleryItem->caption) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('hashtags') is-invalid @enderror"
                               ...
                               value="{{ old('hashtags', is_array($galleryItem->hashtags) ? implode(', ', $galleryItem->hashtags) : '') }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" class="form-control @error('link') is-invalid @enderror"
                               id="link" name="link"
                               value="{{ old('link', $galleryItem->link) }}"
                        ...
                        <select class="form-select @error('product_id') is-invalid @enderror"
                            ...
                            @foreach($products as $product)
                                <option value="{{ $product->id }}"
                                    {{ old('product_id', $galleryItem->product_id) == $product->id ? 'selected' : '' }}>
                                    {{ $product->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-4">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is_featured"
                                ...
                                {{ old('is_featured', $galleryItem->is_featured) ? 'checked' : '' }}>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('galleryForm').addEventListener('submit', function(e) {
                ...
                if (sourceType === 'upload') {
                    ...
                    // Only validate file size if a new image is selected
                    if (image) {
