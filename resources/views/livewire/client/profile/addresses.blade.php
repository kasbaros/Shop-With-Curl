...
{{--        <button class="tf-btn btn-fill animate-hover-btn rounded-0 justify-content-center" wire:click="resetForm"--}}
{{--                data-bs-toggle="collapse" data-bs-target="#addressForm">Add New--}}
{{--        </button>--}}
{{--    </div>--}}
...
{{--                                <button class="btn btn-sm btn-outline-secondary" wire:click="edit({{ $addr->id }})">--}}
{{--                                    Edit--}}
{{--                                </button>--}}
{{--                                <button class="btn btn-sm btn-outline-danger" wire:click="delete({{ $addr->id }})">--}}
{{--                                    Delete--}}
{{--                                </button>--}}
...
{{--                    <button class="tf-btn btn-fill animate-hover-btn rounded-0 justify-content-center"--}}
{{--                            wire:click="showNewAddressForm">Add your first address--}}
{{--                    </button>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        @endforelse--}}
...
{{--                        <button type="button" class="tf-btn btn-fill animate-hover-btn rounded-0 justify-content-center"--}}
{{--                                data-bs-toggle="collapse" data-bs-target="#addressForm">Cancel--}}
{{--                        </button>--}}
{{--                        <button type="submit"--}}
{{--                                class="tf-btn btn-fill animate-hover-btn rounded-0 justify-content-center">Save--}}
{{--                        </button>--}}
{{--                    </div>--}}
{{--                </form>--}}
{{--            </div>--}}
...
<div>
    <div class="d-flex justify-content-between align-items-center mb_20">
        <h5 class="fw-6 m-0">My Addresses</h5>
        <button class="tf-btn btn-fill animate-hover-btn rounded-0 justify-content-center" wire:click="showNewAddressForm">Add New</button>
    </div>
    ...
    <div class="row g-3 mb_20">
        @forelse($addresses as $addr)
            <div class="col-md-6" wire:key="addr-{{ $addr->id }}">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div>
                            ...
                            <div class="d-flex gap-2">
                                <button class="btn btn-sm btn-outline-secondary" wire:click="edit({{ $addr->id }})">Edit</button>
                                <button class="btn btn-sm btn-outline-danger" wire:click="delete({{ $addr->id }})">Delete</button>
                            </div>
                        </div>
                        <div class="fw-6">{{ $addr->name }}</div>
        ...
        @empty
            <div class="col-12">
                <div class="text-center p-4 border rounded bg-light">
                    <p class="mb-2">You have no saved addresses.</p>
                    <button class="tf-btn btn-fill animate-hover-btn rounded-0 justify-content-center" wire:click="showNewAddressForm">Add your first address</button>
                </div>
            </div>
        @endforelse
    </div>
        ...
        <div id="addressForm">
            <div class="card card-body">
                ...
                <form wire:submit.prevent="save" class="row g-3">
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2">
                        <button type="button" class="tf-btn btn-fill animate-hover-btn rounded-0 justify-content-center" wire:click="$set('showForm', false)">Cancel</button>
