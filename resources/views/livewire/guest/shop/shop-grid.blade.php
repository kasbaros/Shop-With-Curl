                    ...
                    <div class="p-3 border rounded-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-2">
                                <input type="number" class="form-control" placeholder="Min" min="0" wire:model.live.debounce.500ms="minPrice">
                                <input type="number" class="form-control" placeholder="Max" min="0" wire:model.live.debounce.500ms="maxPrice">
                            </div>
                            <small class="text-muted d-block mt-1">Tip: set both min and max</small>
                        </div>

                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="inStockOnly" wire:model.live="inStockOnly">
